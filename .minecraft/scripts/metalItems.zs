...
global metalItems as IIngredient[string][string] = {
	...
	bronze: {
		...
		rod: null,
		bow:<thermalfoundation:tool.bow_bronze>,
		fishing_rod:<thermalfoundation:tool.fishing_rod_bronze>},
	chrome: {
		block: <techreborn:storage:3>,
		comb: <gendustry:honey_comb:103>,
		dust: <techreborn:dust:10>,
		gear: <contenttweaker:material_part:9>,
	...
	cobalt: {
		...
		dust: null,
		gear: <contenttweaker:material_part:35>,
		ingot: <tconstruct:ingots>,
		liquid: <liquid:cobalt>,
		nugget: <tconstruct:nuggets>,
		plate: <contenttweaker:material_part:36>,
		rod: null},
	constantan: {
		...
		rod: null,
		bow:<thermalfoundation:tool.bow_constantan>,
		fishing_rod:<thermalfoundation:tool.fishing_rod_constantan>},
	copper: {
		...
		rod: null,
		bow:<thermalfoundation:tool.bow_copper>,
		fishing_rod:<thermalfoundation:tool.fishing_rod_copper>},
	electrum: {
		...
		rod: null,
		bow:<thermalfoundation:tool.bow_electrum>,
		fishing_rod:<thermalfoundation:tool.fishing_rod_electrum>},
	elementium: {
		...
		plate: <contenttweaker:material_part:38>,
		rod: null},
	enderium: {
	...
	enhancedgalgadorian: {
		...
		dust: null,
		gear: <contenttweaker:material_part:19>,
		ingot: <stevescarts:modulecomponents:49>,
		liquid: <liquid:enhanced_galgadorian>,
		nugget: <contenttweaker:material_part:21>,
		plate: <contenttweaker:material_part:20>,
		rod: null},
	galgadorian: {
		...
		nugget: <contenttweaker:material_part:17>,
		plate: <contenttweaker:material_part:16>,
		rod: null},
	gold: {
		...
		rod: null,
		bow:<thermalfoundation:tool.bow_gold>,
		fishing_rod:<thermalfoundation:tool.fishing_rod_gold>},
	invar: {
		...
		rod: null,
		bow:<thermalfoundation:tool.bow_invar>,
		fishing_rod:<thermalfoundation:tool.fishing_rod_invar>},
	iridium: {
	...
	iron: {
		...
		bow:<thermalfoundation:tool.bow_iron>,
		fishing_rod:<thermalfoundation:tool.fishing_rod_iron>},
	knightslime: {
		...
		plate: <contenttweaker:material_part:40>,
		rod: null},
	lead: {
		...
		rod: null,
		bow:<thermalfoundation:tool.bow_lead>,
		fishing_rod:<thermalfoundation:tool.fishing_rod_lead>},
	lumium: {
	...
	nickel: {
		...
		rod: null,
		bow:<thermalfoundation:tool.bow_nickel>,
		fishing_rod:<thermalfoundation:tool.fishing_rod_nickel>},
	platinum: {
		...
		rod: null,
		bow:<thermalfoundation:tool.bow_platinum>,
		fishing_rod:<thermalfoundation:tool.fishing_rod_platinum>},
	pigiron: {
		block: <tconstruct:metal:4>,
		comb: <gendustry:honey_comb:125>,
		dust: null,
		gear: <contenttweaker:material_part:45>,
		ingot: <tconstruct:ingots:4>,
		liquid: <liquid:pigiron>,
		nugget: <tconstruct:nuggets:4>,
		plate: <contenttweaker:material_part:46>,
		rod: null},
	reinforcedmetal: {
		block: <stevescarts:blockmetalstorage:0>,
		comb: <gendustry:honey_comb:128>,
		dust: null,
		gear: <contenttweaker:material_part:23>,
		ingot: <stevescarts:modulecomponents:22>,
		liquid: <liquid:reinforced_metal>,
		nugget: <contenttweaker:material_part:25>,
		plate: <contenttweaker:material_part:24>,
		rod: null},
	signalum: {
	...
	silver: {
		...
		rod: null,
		bow:<thermalfoundation:tool.bow_silver>,
		fishing_rod:<thermalfoundation:tool.fishing_rod_silver>},
	steel: {
		...
		bow:<thermalfoundation:tool.bow_steel>,
		fishing_rod:<thermalfoundation:tool.fishing_rod_steel>},
	terrasteel: {
	...
	tin: {
		...
		rod: null,
		bow:<thermalfoundation:tool.bow_tin>,
		fishing_rod:<thermalfoundation:tool.fishing_rod_tin>},
	titanium: {
		block: <techreborn:storage:2>,
		comb: <extrabees:honey_comb:41>,
		dust: <techreborn:dust:54>,
		gear: <contenttweaker:material_part:7>,
	...
	tungsten: {
		...
		gear: <contenttweaker:material_part:11>,
	...
	tungstensteel: {
		...
		dust: null,
		gear: <contenttweaker:material_part:13>,
